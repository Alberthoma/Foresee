...
- **Versión activa:** `V F2 0014` (2026-07-24) — fix en Reportes: un usuario sin transacciones (o viendo un mes sin gastos) hacía crashear los 6 gráficos por un `<option>` de placeholder sin `value` que se colaba como si fuera un mes real. Blindado en `currentRepMonth()`, el único punto de verdad del mes en esa sección.
- **Próxima versión:** `V F2 0015`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0014 — 2026-07-24.md` (app) y `Informes de actualización/Cloud Functions y Notificaciones — 2026-07-24.md` (backend)
- **Último respaldo:** `Respaldos/V F2 0014 — 2026-07-24/`
