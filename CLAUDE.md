...
- **Versión activa:** `V F2 0018` (2026-07-26) — Al desplegar "Filtros" en Registros/Proyección, los selects desordenaban toda la fila de íconos (el botón "Filtros" se volvía de ancho completo). Se separaron los selects/checkbox en un `<div class="filter-selects">` propio, con `#reg-filter-group`/`#proj-filter-group` en `display: contents` para que el botón "Filtros" se comporte como un ícono más y los selects caigan en su propia fila (`flex-basis: 100%`, `order` alto), debajo de todo. De paso, esas dos secciones pasan de "agrupado a la derecha" a repartir sus 4 íconos (Inicio/botón propio/Filtros/Ayuda) en partes iguales (`even-secondary`, `justify-content: space-between`). Íconos de "+ Registrar"/"+ Proyección" de 22px a 25px. Verificado con Playwright (capturas a 390px, filtros cerrados y abiertos). Bump de `CACHE_NAME` (v18→v19).
- **Próxima versión:** `V F2 0019`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0018 — 2026-07-26.md`
- **Último respaldo:** `Respaldos/V F2 0018 — 2026-07-26/`
