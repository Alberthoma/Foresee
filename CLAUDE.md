...
- **Versión activa:** `V F2 0017` (2026-07-26) — El espacio entre el tab-bar y la barra de acciones seguía viéndose muy grande tras V F2 0016. Se descartó reducir `--tab-bar-mobile-h` (cortaba las pestañas de 2 líneas, ej. "Gastos Recurrentes" — probado y revertido). La causa real: `#main-wrapper` (contenedor de `#content-area`) tenía su propio `padding-top` independiente del hueco reservado para el tab-bar fijo — reducido puntualmente sin tocar el tab-bar. Verificado con Playwright (instalado en scratchpad, no en el repo) comparando capturas a 390px antes/después. Bump de `CACHE_NAME` (v17→v18).
- **Próxima versión:** `V F2 0018`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0017 — 2026-07-26.md`
- **Último respaldo:** `Respaldos/V F2 0017 — 2026-07-26/`
