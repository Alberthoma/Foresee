...
- **Versión activa:** `V F2 0015` (2026-07-24) — `onAuthStateChanged` (`js/main.js`) trataba cada disparo con usuario válido como un login nuevo (pantalla de carga + recarga completa de datos + pantalla de bienvenida otra vez), incluso cuando Firebase solo revalidaba una sesión ya activa. Ahora se compara el `uid` contra el último cargado y se ignoran los disparos redundantes — evita una fuga de listeners de Firestore duplicados. **Este cambio es correcto y se queda, pero no era la causa del "reinicio" al cambiar de pestaña que reportó el usuario** — ver la nota corregida en "Deuda técnica" más abajo, la causa real era una extensión del navegador (IDM Integration Module), no la app.
- **Próxima versión:** `V F2 0016`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0015 — 2026-07-24.md`
- **Último respaldo:** `Respaldos/V F2 0015 — 2026-07-24/`
