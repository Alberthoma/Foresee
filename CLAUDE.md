...
- **Versión activa:** `V F2 0016` (2026-07-26) — Rediseño de la barra de acciones para mobile: columna Saldo oculta en Registros (visible al tocar la fila, junto a editar/borrar); "Transferir" pasó a ser una pestaña dentro del formulario "+ Registrar" en vez de un botón aparte; botones "+ Registrar"/"+ Proyección" con íconos reales (Ingreso/Gasto/Transferencia) y fondo neutro; mismo fondo neutro para los "+ Añadir" de Recurrentes/Tarjetas/Comunes/Metas; Registros y Proyección quedan en una sola fila (Inicio/botón propio/Filtros/Ayuda); Recurrentes/Comunes/Tarjetas/Metas con su botón centrado; "Eliminar selección" reducido a ícono 🗑️ sin fondo; flecha de Filtros más grande sin empujar "Cómo funciona"; menos espacio entre tab-bar/acciones/tablas. De paso, se restauró el formato compacto de `index.html` tras detectar que Prettier lo había reformateado por completo (atributo por línea). Bump de `CACHE_NAME` (v16→v17).
- **Próxima versión:** `V F2 0017`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0016 — 2026-07-26.md`
- **Último respaldo:** `Respaldos/V F2 0016 — 2026-07-26/`
