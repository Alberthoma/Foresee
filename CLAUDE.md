...
- **Versión activa:** `V F2 0019` (2026-07-26) — Reportes rediseñado: en vez de 8 gráficos apilados con scroll, ahora es una **lista** (ícono + título + descripción) que al tocar un ítem abre su **detalle** individual. La flecha "Inicio" es sensible al contexto — dentro de un reporte vuelve a la lista en vez de al dashboard. En mobile se quitó el botón "Filtros" de Reportes (el select de mes queda siempre visible y centrado en la fila). De paso, se corrigió el botón "Ayuda" que se veía ovalado en escritorio (`line-height:0` pensado para el SVG de "Inicio" rompía el texto/emoji de Ayuda) y un bug donde el select de mes no se llenaba en la vista de lista. Verificado con Playwright, incluida una prueba con datos simulados vía `import("/js/state.js")`. Bump de `CACHE_NAME` (v19→v20).
- **Próxima versión:** `V F2 0020`
...
- **Último informe de actualización:** `Informes de actualización/V F2 0019 — 2026-07-26.md`
- **Último respaldo:** `Respaldos/V F2 0019 — 2026-07-26/`
