...
// Clave pública de reCAPTCHA v3 (google.com/recaptcha/admin, sitio
// "WittFinances") — igual que el resto de FIREBASE_CONFIG, no es secreta.
// El enforcement real (bloquear pedidos sin token válido) se activa
// aparte en Firebase Console → App Check, no acá.
export const APP_CHECK_SITE_KEY = "6Lew4FotAAAAABNZIUZKyBsjJyaVJkvf8VDfrN5-";
