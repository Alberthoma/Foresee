...
function updateActionBar(tabName) {
  ...
  // En mobile, las secciones con 2+ botones propios (Registros, Proyección)
  // bajan esos botones a su propia fila, repartidos en partes iguales; el
  // resto los deja en la misma fila que "Inicio"/"Cómo funciona" (ver CSS
  // #action-bar.split-secondary en base.css).
  document.getElementById("action-bar")?.classList.toggle("split-secondary", visible.length >= 2);
}
