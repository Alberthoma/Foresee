...
let onTransferCb = null;

export function openCalcModal({ editItem = null, initialTipo = "expense", onFinalize, onTransfer = null, showTransferTab = false, titleNew = "Nueva Transacción", titleEdit = "Editar Transacción" } = {}) {
  const today = new Date().toISOString().slice(0, 10);
  calcExpr = "0";
  tempData = {};
  editId = null;
  onFinalizeCb = onFinalize;
  onTransferCb = onTransfer;
  document.getElementById("calc-tipo-transfer").classList.toggle("hidden", !showTransferTab);
