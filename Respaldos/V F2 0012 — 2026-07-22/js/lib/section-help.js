...
const SECTION_HELP = {
  ...
  "gastos-comunes": {
    ...
    steps: [
      "Presiona “+ Añadir Ítem”: nombre del gasto y monto total.",
  ...
  tarjetas: {
    ...
    steps: [
      "Presiona “+ Añadir Tarjeta”: nombre, monto que debes hoy, línea de crédito, día de pago, interés anual, y meses para saldarla.",
